<!DOCTYPE html>
<!-- 
Template Name: WePlay - Responsive Admin Dashboard Template build with Twitter Bootstrap 3.3.6
Version: 4.6
Author: KeenThemes
...
Purchase: http://themeforest.net/item/WePlay-responsive-admin-dashboard-template/4021469?ref=keenthemes
Renew Support: http://themeforest.net/item/WePlay-responsive-admin-dashboard-template/4021469?ref=keenthemes
...
<html lang="en">
    ...
    <body class=" login">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2014 &copy; WePlay.club </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
